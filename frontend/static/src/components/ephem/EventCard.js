                ...
                <div className="card h-100">
                    <div className="card-header">
                        <div className="img-container">
                            <img style={{height: '100%'}} src={this.props.item.image} alt="A planet, star or satellite."/>
                        </div>
                    ...
                    <button onClick={(event) => this.handleText(event, this.props.index)} className="btn-primary">Remind me
                    </button>
                    {
                        this.props.isAdmin
                            ?
